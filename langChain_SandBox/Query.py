...
def get_merged_answers(query:str):
     merged = []
     seen = set()
     BM25_docs = get_BM25_Answer(query, k=5)
     V_store_docs = get_Answer(query=query, k=5)
...
def get_merged_answers_reWrite(query:str):
         ...
         BM25_docs = get_BM25_Answer(rewritten_query, k=5)
         V_store_docs = get_Answer(query=rewritten_query, k=5)
         for item in BM25_docs + V_store_docs:
